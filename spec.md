...
# "校园食鉴录" (Campus Taste Archive) 校园生活真实红黑榜
...
### 1.1 单线描述
**"校园食鉴录" (Campus Taste Archive)** —— 专属于在校大学生的校园生活"真实红黑榜"与店铺五星评分统计搜索引擎。致力于为大学生打造一个真实、可信、实名制的校园消费评价体系，彻底杜绝水军刷评，让每一位同学都能参考真实的红黑榜体验，"别瞎买"。
...
```sql
-- =====================================================
-- "校园食鉴录" (Dinescope Campus) - 数据库初始化脚本
...
| 版本   | 日期         | 修改内容                      | 作者  |
|------|------------|---------------------------|-----|
| v1.0 | 2026-05-21 | 初始版本，完整定义需求、实体、用户流、Schema | 张庭宁 |
| v1.1 | 2026-05-26 | 更新版本，优化UI设计、完善部分功能        | 胡子晗 |
